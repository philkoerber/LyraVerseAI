...
function CreateNewLyric({ session }) {
  ...
  async function insertNewLyric() {
    ...
    try {
      ...
      console.log("error creating new lyric", error);
    } finally {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}>
      <button
        className="w-[75px] h-[75px] bg-neutral-400 hover:bg-green-400 rounded-full border-black border-[1px] flex justify-center items-center shadow-lg transition duration-100"
        onClick={handleClick}
